...
<body>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                                            <ul class="nav navbar-nav">
                                                    ...
                                                    <li  class="active"><a href="offers_Arabic.php">العروض</a></li>
                                                    <li><a href="knowledge_Arabic.php">الاثراء</a></li>
                                                    ...
                                                    <li class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                    <li><a href="offers.php">الانجليزية</a></li>
                                                                    <li><a href="offers_Arabic.php">العربية</a></li>
                                                            </ul>
                                                          </li>
    ...
    <section class="content content-3" id="sec3" style="">
        <div class="container">
            <div class="row">
        ...
        <section class="content" style="margin-top: 30px;">
          <div class="row">
              ...
              <div class="col-md-12">
                    <div class="row">
                            <a href="take_the_offer_Arabic.php"><div data-aos="fade-up" data-aos-duration="1500" class="col-md-12 cont-div" style="">
                                    <div class="row">
